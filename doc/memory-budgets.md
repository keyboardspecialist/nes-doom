...
- Bank-0 WRAM reserved: approximately 6,184 bytes, leaving 2,008 bytes.
...
Bank 0 reserves approximately 6,184 bytes and leaves approximately 2,008
bytes free.
...
1. Use free PRG-ROM banks 09-0C for new systems and cold code.
